...
import { actionCreator } from 'store/reducers/widgetAppointment'
import styled from 'styled-components'

import BadgeIcon from '@material-ui/icons/PersonAdd'

const UserWidget = props => {

    const dispatch = useDispatch();
    const mapState = useCallback(state => ({ ...state.widgetAppointment }), [])
    ...
    return (
        <Wrapper>
            ...
            <Content>
                <Title variant="body2">Желающие на запись</Title>
