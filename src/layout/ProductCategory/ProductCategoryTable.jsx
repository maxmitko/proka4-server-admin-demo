...
import { actionCreator } from 'store/reducers/productCategory'
...
const ProductCategoryTable = props => {
    ...
    const mapState = useCallback(state => ({ ...state.productCategory }), [])
    ...
    return (
        <Paper>
            <Label><Text variant="h6">Категории</Text></Label>
