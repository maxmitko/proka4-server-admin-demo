...
import { ButtonsWrapper } from '../../Users/UsersEditForm'

const UserCardTable = props => {

    const { userId, locales } = props
    const { data, loading } = props.userCard
    const { fetchList, removeItem, createItem, updateItem } = props
